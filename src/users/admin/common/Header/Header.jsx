  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Documents Rejected Files",
          icon: <i class="fa-solid fa-graduation-cap"></i>,
          matchings: ["rejected-files"],
          path: "/d/admin/documents-rejected-files",
        },
        {
          label: "Permanent Rejected Files",
          icon: <i class="fa-solid fa-graduation-cap"></i>,
          matchings: ["rejected-files"],
          path: "/d/admin/permanent-rejected-files",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: <i class="fa-solid fa-person-rays"></i>,
          count: state.totalAssessmentForms,
        ...
        },
        {
          ...
          count: state.totalSearchQueryForms,
    ...
    },
    {
      label: "Settings",
      icon: <i class="fa-solid fa-person-rays"></i>,
      matchings: ["currency", "required-documents"],
      items: [
        {
        ...
        },
        {
          ...
          path: "/d/admin/required-documents",
        },
      ],
    },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="bg-[#e2e8f0] xl:flex justify-center p-3 items-center space-x-3 h-[72px]">
          <img src="https://www.learnglobal.com/schoollogo/logo-fixed.png" className="w-10/12" alt="" />
        ...
        <p className="roleStyle">
          {firstName ? (
            <span>
              Welcome, <span id="header-firstname">{firstName}</span>{" "}
            </span>
          ) : (
            <span>Welcome</span>
          )}
