                                ...
                                <div className="card mb-4 mt-4">
                                    <div className="card-body px-0 pt-0 pb-2">
                                        <div className="table-responsive p-0">
                                            <table className="table-responsive w-full mb-0 designedTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th className="text-left border-2 p-2 ">Exam Type</th>
                                                        <th className="text-left border-2 p-2 ">Writing</th>
                                                        <th className="text-left border-2 p-2 ">Reading</th>
                                                        <th className="text-left border-2 p-2 ">Speaking</th>
                                                        <th className="text-left border-2 p-2 ">Listening</th>
                                                        <th className="text-left border-2 p-2 ">Score</th>
...

                                                    {
                                                        state.students.map((student, index) => {
                                                            return <tr>
                                                                ...
                                                                <td className="p-2 text-left">
                                                                    <p className="text-xs font-weight-bold mb-0">{student.examType}</p>
                                                                </td>
                                                                <td className="p-2 text-left">
                                                                    <p className="text-xs font-weight-bold mb-0">{student.scores[0] || "--"}</p>
                                                                </td>
                                                                <td className="p-2 text-left">
                                                                    <p className="text-xs font-weight-bold mb-0">{student.scores[1] || "--"}</p>
                                                                </td>
                                                                <td className="p-2 text-left">
                                                                    <p className="text-xs font-weight-bold mb-0">{student.scores[2] || "--"}</p>
                                                                </td>
                                                                <td className="p-2 text-left">
                                                                    <p className="text-xs font-weight-bold mb-0">{student.scores[3] || "--"}</p>
                                                                </td>
                                                                <td className="p-2 text-left">
                                                                    {
                                                                        student.examType == "IELTS" ?
                                                                            <p className="text-xs font-weight-bold mb-0">{student.overall_score}</p> :
                                                                            <p className="text-xs font-weight-bold mb-0">{student.scores}</p>
                                                                    }
                                                                </td>
                                                                <td className="p-2 text-left">
                                                                    <p className="text-xs font-weight-bold mb-0">{(new Date(parseInt(student.created))).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</p>
                                                                </td>
