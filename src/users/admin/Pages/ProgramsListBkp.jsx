                                    ...
                                    <div className="card-body px-0 pt-0 pb-2">
                                        <div className="table-responsive p-0">
                                            <table className="table mb-0 w-full">
                                                <thead>
                                                    <tr>
                                                        <th className="border-2 border-black text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Sr.</th>
                                                        <th className="border-2 border-black p-2 text-left text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Program</th>
                                                        <th className="border-2 border-black p-2 text-left align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Intakes</th>
                                                        <th className="border-2 border-black p-2 text-left align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Duration</th>
                                                        <th className="border-2 border-black p-2 text-left align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Few Seats</th>
                                                        <th className="border-2 border-black p-2 text-left align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Intake Status</th>
