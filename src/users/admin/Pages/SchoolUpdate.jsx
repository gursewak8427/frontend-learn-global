...
const SchoolUpdate = () => {
    ...
    useEffect(() => {
        // get Single Schools
        axios.post(process.env.REACT_APP_NODE_URL + "/admin/getSingleSchool", { schoolId }).then(res => {
            ...
            setState({
                ...
                international_student: res.data.details.schoolDetails.international_student || "",
                accomodation_feature: res.data.details.schoolDetails.accomodation_feature || "",
                work_permit_feature: res.data.details.schoolDetails.work_permit_feature || "",
                program_cooporation: res.data.details.schoolDetails.program_cooporation || "",
                work_while_study: res.data.details.schoolDetails.work_while_study || "",
                condition_offer_letter: res.data.details.schoolDetails.condition_offer_letter || "",
                            ...
                            <div class="card-body">
                                ...
                                <div className="flex">
                                    <div class="m-3 w-6/12">
                                        ...
                                        <input
                                            ...
                                            type="text" class="capitalize block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm"
                                            name="school_name"
                                ...
                                <div class="flex">
                                    <div class="m-3 w-6/12">
                                        ...
                                        <select
                                            ...
                                            <option value="public college" selected>Public College</option>
                                ...
                                <div className="flex">
                                    <div class="m-3 w-6/12">
                                        ...
                                        <input
                                            ...
                                            type="checkbox" class="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm"
                                            name="accomodation_feature"
                                            value={state.accomodation_feature}
                                            onChange={handleChange} />
                                    </div>
                                    <div class="m-3 w-6/12">
                                        <label>Work Permit Feature</label>
                                        <input
                                            placeholder="Total Work Permit Feature"
                                            type="text" class="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm"
                                            name="work_permit_feature"
                                            value={state.work_permit_feature}
                                            onChange={handleChange} />
                                    </div>
                                </div>
                                ...
                                <div className="flex">
                                    <div class="m-3 w-6/12">
                                        ...
                                        <input
                                            placeholder="Total Program Cooporation"
                                            type="text" class="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm"
                                            name="program_cooporation"
                                            value={state.program_cooporation}
                                            onChange={handleChange} />
                                    </div>
                                    <div class="m-3 w-6/12">
                                        <label>Work While Study</label>
                                        <input
                                            placeholder="Total Work While Study"
                                            type="text" class="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm"
                                            name="work_while_study"
                                            value={state.work_while_study}
                                            onChange={handleChange} />
                                    </div>
                                </div>
                                ...
                                <div className="flex">
                                    <div class="m-3 w-6/12">
                                        ...
                                        <input
                                            placeholder="Total Condition Offer Letter"
                                            type="text" class="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm"
                                            name="condition_offer_letter"
                                            value={state.condition_offer_letter}
                                            onChange={handleChange} />
                                    </div>
                                    <div class="m-3 w-6/12">
                                        <label>Library</label>
                                        <input
                                            placeholder="Total Library"
                                            type="text" class="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm"
                                            name="library"
                                            value={state.library}
                                            onChange={handleChange} />
                                ...
                                <button type="button" class="btn bg-gradient-primary w-100 mt-4 text-white px-2 py-1 rounded m-3" onClick={() => Update()}>Update</button>
                            </div>
                        </div>
                    </div>
                </>
