      ...
      <div heading_title={"Sub-Admin List"}>
        <>
          <div className="mt-10 px-10">
            <button class="hover:bg-black text-white font-bold py-2 px-4 rounded capitalize flex ml-auto items-center gap-1 list-emp">
              <svg
            ...
            <div className="popup permissions">
              <h2 className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-[20px] m-2 py-1 px-4 rounded hover:bg-[#991b1b] bg-[#dc2626]"
                >
                  Close
                </button>
              </h2>
              ...
              <button
                className="float-right mb-10 m-2 py-2 px-5 bg-[#2a276b] hover:bg-[#2a266bb4] text-white rounded-full"
                          ...
                          return (
                            <tr className="w-full">
                              ...
                              <td className="p-2 align-middle">
                                <span
                                  className="text-[#2a276b] font-bolder cursor-pointer"
                                  onClick={() => {
                                    setState({
                                      ...state,
