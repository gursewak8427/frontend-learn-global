        ...
        axios.post(process.env.REACT_APP_NODE_URL + "/student/login", data2).then(res => {
            ...
            authenticate(res, "student", () => {
                if (state.redirect == "true") {
                    ...
                    const config = { headers: { "Authorization": `Bearer ${res.data.details.token}` } }
                ...
                <>
                    <div className="">
                        ...
                        <div className="text-center pt-2 px-lg-2 px-1">
                            ...
                            <p className="mb-4 text-sm mx-auto">
                                <span onClick={() => navigate("/d/student/forgot")} className="pl-2 text-info text-gradient font-bold cursor-pointer">Forgot Password</span>
                            </p>
                        </div>
                    </div>
                </>
