...
const StudentEmbassyDocuments = (props) => {
    ...
    useEffect(() => { // get docs list
        ...
        axios.post(process.env.REACT_APP_NODE_URL + "/student/getEmbacyDocs", { fileId: searchParams.get("fileId") }, config).then((res) => {
            setState({
                ...state,
                documentsList: res.data.details.documents,
                enroll_status: res.data.details.enroll_status,
    ...
    const addDocument = async (e) => {
        ...
        formData.append("fileId", searchParams.get("fileId"));
        ...
        axios.post(process.env.REACT_APP_NODE_URL + "/student/uploadembacydocument", formData, config).then((res) => {
            console.log(res);
    ...
    const submitAllDocs = () => {
        ...
        axios.post(process.env.REACT_APP_NODE_URL + "/student/submitEmbassyDocsAll", { fileId: searchParams.get("fileId") }, config).then((res) => {
                ...
                state.isWait ? (
                    ...
                    <>
                            ...
                            }></div>
                        {
                            ...
                            <div className="text-[white] m-[20px] bg-[red] p-2 text-xl font-bold capitalize">Please Pay Application fees before upload documents!</div>
                        }
                        <div className={
                                ...
                                state?.student?.status != "APPROVED" ? (
                                    <>
                                        ...
                                        </button> */}
                                        {
                                            ...
                                            ["FILE_LODGED", "FILE_LODGED_DOCS_PROCESSING", "FILE_LODGED_DOCS_REJECTED"].includes(state.enroll_status) &&
                                            <ButtonPrimary
...
export default StudentEmbassyDocuments;
