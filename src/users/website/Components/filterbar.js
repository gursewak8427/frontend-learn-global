  ...
  return (
    <Accordion>
      <Accordion.Title
        ...
        className={`flex items-center pb-0 filter-tab-title ${activeIndex == 0 ? "active" : ""}`}
      >
        <Icon name="dropdown" />
      ...
      <Accordion.Content className={`${activeIndex == 0 ? "filter-tab active" : "filter-tab"}`}>
                ...
                filters.exam.type == "IELTS" ?
                  <div className="lg:flex  inner-course" style={{}}>
                    <div>
                      ...
                      <input type="text" name="speaking" value={state.iletsScore[2]} onChange={(e) => handleChangeExam(e)} className="me-3 speaking border border-current h-9 p-2" />
                    </div>
                    <div>
                      <label className="text-white">Listening:</label>
                      <input type="text" name="listening" value={state.iletsScore[3]} onChange={(e) => handleChangeExam(e)} className="me-3 listening border border-current  h-9 p-2" />
                    </div>
                    <div>
                      <label className="text-white">Reading:</label>
                      <input type="text" name="reading" value={state.iletsScore[1]} onChange={(e) => handleChangeExam(e)} className="me-3 reading border border-current  h-9 p-2" />
                    </div>
                    <div>
                    ...
                    <input type="text" name="tofel_score" value={state.tofelScore} onChange={(e) => handleChangeExam(e)} className="writing border border-current  h-9 p-2 w-full" />
                    ...
                    <input type="text" name="pte_score" value={state.pteScore} onChange={(e) => handleChangeExam(e)} className="writing border border-current  h-9 p-2 w-full" />
      ...
      <Accordion.Title
        ...
        className={`flex items-center pb-0 filter-tab-title ${activeIndex == 1 ? "active" : ""}`}
      >
        <Icon name="dropdown" />
        <h2 className="px-4 py-2 text-white text-xl  m-0 w-full">
          Grade Scores
      ...
      <Accordion.Content className={`${activeIndex == 1 ? "filter-tab active" : "filter-tab"}`}>
        <div className="w-full">
          <div>
      ...
      <Accordion.Title
        ...
        className={`flex items-center pb-0 filter-tab-title ${activeIndex == 2 ? "active" : ""}`}
      >
        <Icon name="dropdown" />
        <h2 className="px-4 py-2  text-xl text-white m-0 w-full">Country</h2>
      </Accordion.Title>
      <Accordion.Content className={`${activeIndex == 2 ? "filter-tab active" : "filter-tab"}`}>
        <div className="w-full">
          <div>
            <label className="font-bold text-white">
              Choose your country
      ...
      <Accordion.Title
        ...
        className={`flex items-center pb-0 filter-tab-title ${activeIndex == 3 ? "active" : ""}`}
      >
        <Icon name="dropdown" />
      ...
      <Accordion.Content className={`${activeIndex == 3 ? "filter-tab active" : "filter-tab"}`}>
        <div className="w-full">
          <div>
      ...
      <Accordion.Title
        ...
        className={`flex items-center pb-0 filter-tab-title ${activeIndex == 4 ? "active" : ""}`}
      >
        <Icon name="dropdown" />
        <h2 className="px-4 py-2  text-xl text-white m-0 w-full">
          Program filters
      ...
      <Accordion.Content className={`${activeIndex == 4 ? "filter-tab active" : "filter-tab"}`}>
        <div className="w-full">
          <div>
      ...
      <Accordion.Title
        ...
        className={`flex items-center pb-0 filter-tab-title ${activeIndex == 5 ? "active" : ""}`}
      >
        <Icon name="dropdown" />
        <h2 className="px-4 py-2  text-xl text-white m-0 w-full">
      ...
      <Accordion.Content className={`${activeIndex == 5 ? "filter-tab active" : "filter-tab"}`}>
        {
          streams.map(item => {
      ...
      <Accordion.Title
        ...
        className={`flex items-center pb-0 filter-tab-title ${activeIndex == 6 ? "active" : ""}`}
      >
        <Icon name="dropdown" />
        <h2 className="px-4 py-2  text-xl text-white m-0 w-full">
          Tuition Fees
      ...
      <Accordion.Content className={`${activeIndex == 6 ? "filter-tab active" : "filter-tab"}`}>
        ...
        <p className="text-white flex items-center">
          ...
          <input type="text" className="w-6/12 mr-2" name="fees_min" placeholder="Minimum"
            onChange={(e) => {
              setFilters({ ...filters, fees: { ...filters.fees, min: e.target.value } })
              applyFilter("fees", {
                ...filters.fees,
                min: e.target.value,
              })
            }} />
          <input type="text" className="w-6/12" name="fees_max" placeholder="Maximum"
            onChange={(e) => {
              setFilters({ ...filters, fees: { ...filters.fees, max: e.target.value } })
              applyFilter("fees", {
                ...filters.fees,
                max: e.target.value,
              })
