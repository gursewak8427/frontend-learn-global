...
export default function WSearch() {
  ...
  const load_more = () => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_NODE_URL}/student/search?page=${state.currentPage + 1
        }`,
        api_data
      )
      .then((response) => {
  ...
  const enrollNow = (sid, pid) => {
    ...
    if (studentToken) {
      ...
      axios
        ...
        .then((response) => {
          document.getElementById(`program_${pid}`).classList.remove("loadingEnrollBtn")
        ...
        <div className="container mx-auto">
          {state.wait ? (
            ...
            <>
              ...
              <div className="filter-part w-full  mt-10 lg:flex px-4 gap-8">
