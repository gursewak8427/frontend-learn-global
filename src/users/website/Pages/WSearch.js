...
export default function WSearch() {
  ...
  const enrollNow = (sid, pid) => {
    ...
    if (studentToken) {
      ...
      navigate("/d?user=student&redirect=true&type=enroll&school=" + sid + "&program=" + pid)
                                      ...
                                      return <div>
                                        ...
                                        <li className="mb-5">
                                          <p className="text-left">
                                            ...
                                            <table className="programTable">
                                              <tr className="m-1">
                                                ...
                                                </span><span className="text-[16px]">Tuition Fee</span></th>
                                                <th className="px-3 m-1 mr-3"><span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#149449" class="w-6 h-6">
                                                  <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5" />
                                                </svg>

                                                </span><span className="text-[16px]">Application Fee</span></th>
                                                <th className="px-3 m-1 mr-3"><span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#149449" class="w-6 h-6">
                                                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                </svg>
                                                </span><span className="text-[16px]">Duration</span></th>
                                                <th className="px-3 m-1 mr-3"><span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#149449" class="w-6 h-6">
                                                  <path stroke-linecap="round" stroke-linejoin="round" d="M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185zM9.75 9h.008v.008H9.75V9zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 4.5h.008v.008h-.008V13.5zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                                                </svg>

                                                </span><span className="text-[16px]">Percentage Required</span></th>
                                              </tr>
                                              <tr>
                                          ...
                                          <div className="info-ftr flex flex-col items-start gap-2">
                                            <button class="bg-[#1c3479] hover:bg-[#1c3479e0] text-white font-bold py-2 px-8 rounded-full capitalize" onClick={() => enrollNow(school._id, program.program_id)}>
                                              enroll now
                                            </button>
                                            {
